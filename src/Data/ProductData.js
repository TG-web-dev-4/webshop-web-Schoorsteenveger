const productsData = [
  ...
  },
  {
    ...
    price: 1800000,
    description:
      "New York's Greenwich Village has some of the most desirable real estate in the world — save for one brownstone on West 10th Street. Known as The House of Death.",
    Rooms: 7,
    Bathrooms: 2,
    Category: ['Gosths'],
    // "Available": True
  },
  {
    ...
    price: 655000,
    description:
      'According to legend, the rambling Victorian mansion that sits on a busy street in San Jose, California, is haunted by the ghosts of everyone killed by a Winchester rifle.',
    Rooms: 0,
    Bathrooms: 13,
    Category: ['Demons'],
    // "Available": True
  },
  {
    ...
    price: 2500000,
    description:
      "While nothing completely nefarious seems to have happened on the estate, the home's former owners seem to remain very active, even in the afterlife. After Vanderbilt died in 1914, his estate passed on to his children.",
    Rooms: 5,
    Bathrooms: 2,
    Category: ['Gosths'],
    // "Available": True
  ...
  },
  {
    ...
    price: 2000000,
    description:
      "The house's haunted history is documented in author Jan Bryant Bartell's Spindrift: Spray from a Psychic Sea.",
    Rooms: 5,
    Bathrooms: 2,
    Category: ['Gosths'],
    // "Available": True
  },
  {
    ...
    price: 100000,
    description:
      'Boothouse. With a history reaching back to 1836, when it was first settled, it is not surprising that the City of Crystal Lake, Illinois, claims its fair share of ghost stories and reports of paranormal activity.',
    Rooms: 5,
    Bathrooms: 2,
    Category: ['Demons'],
    // "Available": True
  },
  {
    ...
    price: 434000,
    description:
      'Castle story. Savannah is widely known as the most haunted city in America. Walk into any historic building or cemetery in Savannah and you may catch sight of ghostly presences surrounding you.',
    Rooms: 5,
    Bathrooms: 2,
    Category: ['Witches'],
    // "Available": True
  },
  {
    ...
    price: 115000,
    description:
      'Known around town as The Castle, this abandoned mansion looks straight out of a horror movie. ',
    Rooms: 5,
    Bathrooms: 2,
    Category: ['Demons'],
    // "Available": True
  },
  {
    ...
    price: 3500000,
    description:
      'The child on the doorstep says enough. Children are creepy as are houses.',
    Rooms: 5,
    Bathrooms: 2,
    Category: ['Witches'],
    // "Available": True
  ...
  },
  {
    ...
    price: 3500000,
    description:
      'Cairndhu House is a crumbling Victorian mansion located off the Coast Road in Carfunnock Country Park, Larne, Northern Ireland. It was built at some point after 1878, as a summer residence for the wealthy Scottish textile industrialist, Stewart Clark, who had married a young woman from Larne.',
    Rooms: 5,
    Bathrooms: 2,
    Category: ['Witches'],
    // "Available": True
  },
  {
    ...
    price: 3500000,
    description:
      'The manor speaks greatly to the imagination, and there are several reasons for that. One is that it has been abandoned for a long time and there are rumours that’s because it’s a haunted house.',
    Rooms: 5,
    Bathrooms: 2,
    Category: ['Demons'],
    // "Available": True
